...
#if defined( CONFIG_SHTPS_SY3X00_DEV ) || defined( CONFIG_SENSOR_SHGRIP )
...
#endif	/* #if defined( CONFIG_SHTPS_SY3X00_DEV ) || defined( CONFIG_SENSOR_SHGRIP ) */
...
static struct clk_freq_tbl ftbl_camss_gp0_1_clk[] = {
	...
	F_MMSS(   6315789,      gpll0,   1,    1,   95),
	F_MMSS(   9523809,      gpll0,   1,    1,   63),
#endif
