...
#	dtb-$(CONFIG_ARCH_MSM8226)	+= apq8026-v2-1080p-mtp.dtb
	...
	dtb-$(CONFIG_MACH_PA28)	+= msm8926-sharp-pa28-v2-720p.dtb
	dtb-$(CONFIG_MACH_LYNX_DL75)	+= msm8926-sharp-dl75-v1-720p.dtb
	dtb-$(CONFIG_MACH_LYNX_DL75)	+= msm8926-sharp-dl75-v2-720p.dtb
	dtb-$(CONFIG_MACH_MM5)	+= msm8926-sharp-mm5-v1-720p.dtb
	dtb-$(CONFIG_MACH_MM5)	+= msm8926-sharp-mm5-v2-720p.dtb
	dtb-$(CONFIG_MACH_WOODY)	+= msm8926-sharp-woody-v1-720p.dtb
	dtb-$(CONFIG_MACH_WOODY)	+= msm8926-sharp-woody-v2-720p.dtb
