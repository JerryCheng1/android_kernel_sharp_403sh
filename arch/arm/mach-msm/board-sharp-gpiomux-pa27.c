...
static struct gpiomux_setting sh_sus_gpio_pd_4ma_in_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_4MA,
	.pull = GPIOMUX_PULL_DOWN,
	.dir = GPIOMUX_IN,
...
static struct gpiomux_setting sh_act_func3_np_4ma_cfg = {
	.func = GPIOMUX_FUNC_3,
	.drv = GPIOMUX_DRV_4MA,
	.pull = GPIOMUX_PULL_NONE,
};
...
static struct msm_gpiomux_config sh_msm8926_gpio_configs[] __initdata = {
	...
	},
	{
		.gpio = 34,
		.settings = {
			[GPIOMUX_ACTIVE]    = &sh_act_func3_np_4ma_cfg,
			[GPIOMUX_SUSPENDED] = &sh_sus_gpio_pd_4ma_in_cfg,
		},
	},
	{
		.gpio = 35,
