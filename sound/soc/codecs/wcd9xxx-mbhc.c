...
#ifdef CONFIG_SH_AUDIO_DRIVER /* 16-009 */
#if (CONFIG_SH_AUDIO_DRIVER_MODEL_NUMBER == 203)
	#define WCD9XXX_V_CS_HS_MAX 600
#else
	#define WCD9XXX_V_CS_HS_MAX 700
#endif /* #if (CONFIG_SH_AUDIO_DRIVER_MODEL_NUMBER == 203) */
#else
#define WCD9XXX_V_CS_HS_MAX 500
#endif /* CONFIG_SH_AUDIO_DRIVER */ /* 16-009 */
...
#ifdef CONFIG_SH_AUDIO_DRIVER /* 16-034 */
		snd_soc_write(mbhc->codec, WCD9XXX_A_MBHC_INSERT_DETECT,
			      (0xF0 | (ins ? (1 << 1) : 0)));
#else /* CONFIG_SH_AUDIO_DRIVER */ /* 16-034 */
		snd_soc_write(mbhc->codec, WCD9XXX_A_MBHC_INSERT_DETECT,
			      (0x68 | (ins ? (1 << 1) : 0)));
#endif /* CONFIG_SH_AUDIO_DRIVER */ /* 16-034 */
	else
#ifdef CONFIG_SH_AUDIO_DRIVER /* 16-034 */
		snd_soc_write(mbhc->codec, WCD9XXX_A_MBHC_INSERT_DETECT,
			      (0xF4 | (ins ? (1 << 1) : 0)));
				...
				enum snd_jack_types jack_type)
{
	...
	if (!insertion) {
		 ...
		 * removal.
		 */
#ifdef CONFIG_SH_AUDIO_DRIVER /*16-033*//*16-046*/
		...
		if (mbhc->mbhc_cfg->detect_extn_cable &&
		    ...
		    (mbhc->hph_status && mbhc->hph_status != jack_type)) {
#endif /* CONFIG_SH_AUDIO_DRIVER */ /*16-033*//*16-046*/
			if (mbhc->micbias_enable && mbhc->micbias_enable_cb &&
			...
			mbhc->zl = mbhc->zr = 0;
#ifdef CONFIG_SH_AUDIO_DRIVER /*16-047*/
			wcd9xxx_set_and_turnoff_hph_padac(mbhc);
#endif /* CONFIG_SH_AUDIO_DRIVER */ /*16-047*/
			wcd9xxx_jack_report(mbhc, &mbhc->headset_jack,
					    0, WCD9XXX_JACK_MASK);
#ifdef CONFIG_SH_AUDIO_DRIVER /*16-033*/
			msleep(100);
#endif /* CONFIG_SH_AUDIO_DRIVER */ /*16-033*/
			mbhc->hph_status &= ~(SND_JACK_HEADSET |
						SND_JACK_LINEOUT |
...
#if !defined( CONFIG_SH_AUDIO_DRIVER ) /* 16-010 *//* invalid range disable */
		if ((!d->mic_bias &&
...
#endif /* 16-010 *//* CONFIG_SH_AUDIO_DRIVER */
	}
...
irqreturn_t wcd9xxx_dce_handler(int irq, void *data)
{
	...
	void *calibration = mbhc->mbhc_cfg->calibration;
#ifdef CONFIG_SH_AUDIO_DRIVER /* 16-004 */
	int temp;
#endif /* CONFIG_SH_AUDIO_DRIVER */ /* 16-004 */
	...
	//mbhc sometimes crashed by unexpected dce_handler call
