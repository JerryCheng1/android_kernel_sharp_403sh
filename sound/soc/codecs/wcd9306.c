...
#ifdef CONFIG_SH_AUDIO_DRIVER /* 16-005 */
...
#endif /* CONFIG_SH_AUDIO_DRIVER */ /* 16-005 */
...
int tapan_esxxx_digital_mute(struct snd_soc_dai *dai, int mute)
{
	return tapan_digital_mute(dai, mute);
}
#endif
/* <-SH_AUDIO_DRIVER */ /*16-065*/
...
static struct snd_soc_dai_ops tapan_dai_ops = {
	...
	.digital_mute = tapan_esxxx_digital_mute,
};
#else
static struct snd_soc_dai_ops tapan_dai_ops = {
