...
#ifdef CONFIG_SH_AUDIO_DRIVER /* 16-065 */
#include <linux/wakelock.h>
#endif /* CONFIG_SH_AUDIO_DRIVER */ /* 16-065 */
#ifdef CONFIG_SH_AUDIO_DRIVER /* 16-068 */
#include "sharp/sh_smem.h"
#include "sharp/shdiag_smd.h"
#endif /* CONFIG_SH_AUDIO_DRIVER */ /* 16-068 */
...
#ifdef CONFIG_SH_AUDIO_DRIVER /* 16-065 */
			.channels_max = 3,
#else /* CONFIG_SH_AUDIO_DRIVER */ /* 16-065 */
			.channels_max = 2,
#endif /* CONFIG_SH_AUDIO_DRIVER */ /* 16-065 */
			.rates = ES705_SLIMBUS_RATES,
			.formats = ES705_SLIMBUS_FORMATS,
...
#else /* CONFIG_SH_AUDIO_DRIVER */ /* 16-068 */
...
/* /sys/devices/fe12f000.slim/earSmart-codec-gen0/check */
#endif /* CONFIG_SH_AUDIO_DRIVER */ /* 16-068 */
...
int es705_core_probe(struct device *dev)
{
	...
	int rc = 0;
/* SH_AUDIO_DRIVER-> */ /*16-065*/
#ifdef CONFIG_SH_AUDIO_DRIVER // (CONFIG_SH_AUDIO_DRIVER_MODEL_NUMBER == 203)
#if defined(CONFIG_MQ100_SENSOR_HUB)
