...
#ifdef CONFIG_SHRECEIVER_LM48560 /* 16-061 */
#include <sharp/shspamp.h>
#ifdef CONFIG_SH_AUDIO_SMARTAMP /* 16-062 */
#include <sharp/shsmartamp_ssm4329.h>
#endif /* CONFIG_SH_AUDIO_SMARTAMP */ /* 16-062 */
#endif /* CONFIG_SHRECEIVER_LM48560 */ /* 16-061 */
...
#ifndef CONFIG_SH_AUDIO_SMARTAMP /* 16-062 */
...
#ifdef CONFIG_SH_AUDIO_DRIVER /* 16-062 */
...
#ifdef CONFIG_SHRECEIVER_LM48560 /* 16-061 */
		if (spk ) {
#else /* CONFIG_SHRECEIVER_LM48560 */ /* 16-061 */
...
#ifdef CONFIG_SH_AUDIO_DRIVER /* 16-002 */
#ifdef CONFIG_SHRECEIVER_LM48560 /* 16-061 */
			if (msm8226_ext_spk_pamp) {
#else /* CONFIG_SHRECEIVER_LM48560 */ /* 16-061 */
...
#else	/* CONFIG_SH_AUDIO_DRIVER */ /* 16-002 */
			if ((msm8226_ext_spk_pamp & LO_1_SPK_AMP) &&
...
#endif	/* CONFIG_SH_AUDIO_DRIVER */ /* 16-002 */
		} else  {
			pr_err("%s: Invalid external speaker ampl. spk = 0x%x\n",
				__func__, spk);
		}
