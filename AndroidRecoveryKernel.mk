...
TARGET_PREBUILT_INT_RECOVERY_KERNEL := $(RECOVERY_KERNEL_OUT)/arch/arm/boot/Image-dtb
else
TARGET_PREBUILT_INT_RECOVERY_KERNEL := $(RECOVERY_KERNEL_OUT)/arch/arm/boot/Image
endif
...
ifeq ($(TARGET_KERNEL_APPEND_DTB), true)
TARGET_PREBUILT_INT_RECOVERY_KERNEL := $(KERNEL_OUT)/arch/arm/boot/Image-dtb
else
TARGET_PREBUILT_INT_RECOVERY_KERNEL := $(KERNEL_OUT)/arch/arm/boot/Image
endif

ifeq ($(TARGET_USES_UNCOMPRESSED_KERNEL),true)
$(info Using uncompressed kernel)
TARGET_PREBUILT_RECOVERY_KERNEL := $(KERNEL_OUT)/piggy
else
TARGET_PREBUILT_RECOVERY_KERNEL := $(TARGET_PREBUILT_INT_RECOVERY_KERNEL)
endif
