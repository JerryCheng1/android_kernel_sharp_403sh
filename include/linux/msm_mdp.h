...
#define MSMFB_SET_SSPP _IOW(MSMFB_IOCTL_MAGIC, 183, struct mdp_overlay_pp_params)
#define MSMFB_MIPI_DSI_CHECK  _IOWR(MSMFB_IOCTL_MAGIC, 184, struct mdp_mipi_check_param)
