...
#define SHCAM_LED_OFF 0
#define SHCAM_LED_TORCH_CURRENT 1
#define SHCAM_LED_PREFLASH_CURRENT 2
#define SHCAM_LED_FLASH_CURRENT 3

#if defined(CONFIG_MACH_LYNX_DL75)
 #define SHCAM_LED_OFF_VALUE 0
 #define SHCAM_LED_TORCH_CURRENT_VALUE 25
 #define SHCAM_LED_PREFLASH_CURRENT_VALUE 25
 #define SHCAM_LED_FLASH_CURRENT_VALUE 150
#elif defined(CONFIG_MACH_PA28)
 #define SHCAM_LED_OFF_VALUE 0
 #define SHCAM_LED_TORCH_CURRENT_VALUE 25
 #define SHCAM_LED_PREFLASH_CURRENT_VALUE 200
 #define SHCAM_LED_FLASH_CURRENT_VALUE 1000
#else
 #define SHCAM_LED_OFF_VALUE 0
 #define SHCAM_LED_TORCH_CURRENT_VALUE 25
 #define SHCAM_LED_PREFLASH_CURRENT_VALUE 25
