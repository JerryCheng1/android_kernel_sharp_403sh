...
typedef struct 
{
    ...
    unsigned char       shdiag_ddrinfo[2];           /* PoP_RAM_Maker Value */
    unsigned int        shdiag_sbstinfo;             /* Substrate Value */
    unsigned char       shdiag_hwv[2];               /* Hardware Version */
} sharp_smem_common_type;

#define SH_SMEM_COMMON_SIZE 20480
