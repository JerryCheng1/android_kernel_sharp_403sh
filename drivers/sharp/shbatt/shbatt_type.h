...
#define SHBATT_DRV_IOCTL_CMD_READ_CALC_BASE_CAPACITY				_IOR( SHBATT_IOCTL_MAGIC,  42, shbatt_calc_base_info_t*)

#define SHBATT_DRV_IOCTL_CMD_GET_IBAT_MAX							_IOR( SHBATT_IOCTL_MAGIC,  43, int)
...
#define SHBATT_DRV_IOCTL_CMD_NOTIFY_CHARGE_STATE_MACHINE_STATUS					_IOW( SHBATT_IOC_MAGIC, 71, shchg_state_t)

#define SHBATT_DRV_IOCTL_CMD_GET_REAL_BATTERY_CAPACITY							_IOR( SHBATT_IOC_MAGIC, 72, int)
...
#define SHBATT_PS_VALUE_INPUT_CURRENT_SETTLED	1
#define SHBATT_PS_VALUE_INPUT_CURRENT_MAX		500
#define SHBATT_PS_VALUE_VOLTAGE_MIN				4400
/*+-----------------------------------------------------------------------------+*/
/*| @ ENUMERATION DECLARE : 													|*/
/*+-----------------------------------------------------------------------------+*/
/*attributes.*/
...
enum
{
	...
	/* power_supply_changed item */
	SHBATT_PS_PROPERTY_STATUS,
	SHBATT_PS_PROPERTY_CHARGE_TYPE,
	SHBATT_PS_PROPERTY_INPUT_CURRENT_SETTLED,
	SHBATT_PS_PROPERTY_INPUT_CURRENT_MAX,
	SHBATT_PS_PROPERTY_VOLTAGE_MIN,
};
...
typedef enum shbatt_api_to_tsk_command_tag
{
	...
	SHBATT_TASK_CMD_NOTIFY_CHARGE_STATE_MACHINE_STATUS,
/*| TODO: New API add point */
	NUM_SHBATT_TASK_CMD,
...
typedef enum
{
	...
	SHBATT_CMD_NOTIFY_CHARGE_STATE_MACHINE_STATUS,
	NUM_SHBATT_CMD,
...
#endif
	SHBATT_DRV_ADC_CHANNEL_USB_ID		= 0x13,	// [ 19] P_MUX4_1_1(MPP4)            = usb_id_pu1
	SHBATT_DRV_ADC_CHANNEL_XO_THERM		= 0xB2,	// [178] LR_MUX3_PU2_XO_THERM        = xo_therm_pu2
#if 1
	SHBATT_DRV_ADC_CHANNEL_MSM_THERM	= 0x15,	// [ 21] P_MUX6_1_1 (MPP6)           = msm_therm_pu2
	SHBATT_DRV_ADC_CHANNEL_CAM_THERM	= 0x15,	// [ 21] P_MUX6_1_1 (MPP6)           = cam_therm_pu2
	SHBATT_DRV_ADC_CHANNEL_PA_THERM0	= 0x14,	// [ 20] P_MUX5_1_1(MPP5)            = pa_therm0_pu2
	SHBATT_DRV_ADC_CHANNEL_PA_THERM1	= 0xB7,	// [183] LR_MUX8_PU2_AMUX_THM4       = pa_therm1_pu2
	SHBATT_DRV_ADC_CHANNEL_LCD_THERM	= 0x17,	// [ 23] LP_MUX8_1_1 (MPP8)          = lcd_therm_pu2
#endif
//	SHBATT_DRV_ADC_CHANNEL_USB_ID		= 0xB9,	// [185] LR_MUX10_PU2_AMUX_USB_ID_LV = usb_id
	...
	SHBATT_DRV_ADC_CHANNEL_BAT_THERM_NO_MOVING_AVE = 0xFD,    // [253] LR_MUX1_BATT_THERM_NO_MOVING_AVE = batt_therm
