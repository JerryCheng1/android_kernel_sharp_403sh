...
struct shtps_facetouch_info{
	...
	int							rezero_disable;
	u8							call_start_rezero_disable_check_state;
...
struct shtps_rmi_spi {
	...
	/* ------------------------------------------------------------------------ */
		...
		struct shtps_filter_diagonal_cling_reject_info		*diagonal_cling_reject_p;
...
#if defined(SHTPS_CTRL_FW_BASELINE_CHECKER_ENABLE)
enum{
	SHTPS_ENM_SET_BASELINE_CHECKER_ENABLE = 0,
	SHTPS_ENM_SET_BASELINE_CHECKER_DISABLE,
};

enum{
	SHTPS_ENM_HOLD_SET_BASELINE_CHECKER_NONE = 0,
	SHTPS_ENM_HOLD_SET_BASELINE_CHECKER_ENABLE,
	SHTPS_ENM_HOLD_SET_BASELINE_CHECKER_DISABLE,
};
#endif /* SHTPS_CTRL_FW_BASELINE_CHECKER_ENABLE */
