...
typedef int (*fwctl_if_get_faceobject_t)(struct shtps_fwctl_info *);
typedef int (*fwctl_if_set_baseline_checker_t)(struct shtps_fwctl_info *, u8);
/* --------------------------------------------------------------------------- */
struct shtps_fwctl_functbl{
	...
	fwctl_if_get_faceobject_t							get_faceobject_f;
	fwctl_if_set_baseline_checker_t						set_baseline_checker_f;
};
/* --------------------------------------------------------------------------- */
	...
	#define shtps_fwctl_get_faceobject(ts)												ts->fwctl_p->fwctl_func_p->get_faceobject_f(ts->fwctl_p)
	#define shtps_fwctl_set_baseline_checker(ts, disable)								ts->fwctl_p->fwctl_func_p->set_baseline_checker_f(ts->fwctl_p, disable)
#else
	...
	void shtps_fwctl_get_motion_suppression(struct shtps_rmi_spi *, u8 *);
	...
	int shtps_fwctl_get_faceobject(struct shtps_rmi_spi *);
	int shtps_fwctl_set_baseline_checker(struct shtps_rmi_spi *, u8);
