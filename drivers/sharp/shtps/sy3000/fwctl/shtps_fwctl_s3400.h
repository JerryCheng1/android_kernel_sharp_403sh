...
#define F51_QUERY_FACEDETECTIONDATAREGISTERADDRESS(data)	data[7]
#define F51_QUERY_BASELINECHECKERREGISTERADDRESS(data)		data[8]
...
struct rmi_map {
	...
	u8		reg_motion_suppression_def[2];
	u8		reg_F12_CTRL11_val[9];
	u8		reg_F12_CTRL15_val[8];
