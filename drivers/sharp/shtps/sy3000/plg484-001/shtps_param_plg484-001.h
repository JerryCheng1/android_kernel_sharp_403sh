/* drivers/sharp/shtps/sy3000/plg484-001/shtps_param_plg484-001.h
 *
 ...
 *
 */
#ifndef __SHTPS_PARAM_PLG484_001_H__
#define __SHTPS_PARAM_PLG484_001_H__
 ...
 */
	...
	SHTPS_PARAM_DEF(SHTPS_FACETOUCH_DETECT_CHECK_FACE_OBJECT_EXISTS,1);
...
//	SHTPS_PARAM_DEF(SHTPS_LOS_MULTI,								0x40);
		...
		SHTPS_PARAM_DEF( SHTPS_FACETOUCHOFF_DETECT_SKIP_REZERO_FIRST_TIME_MS, 	1000);
 ...
 */
	...
	#define SHTPS_PERF_LOCK_CLOCK_FREQUENCY				1190400
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_LPWG_RECEIVER_PITCH,				0x0000);
	SHTPS_PARAM_DEF( SHTPS_LPWG_TRANSMITTER_PITCH,			0x0000);
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_CLING_REJECT_HOVER_ENABLE,					0);
	...
	SHTPS_PARAM_DEF( SHTPS_CLING_REJECT_HOVER_MODE_2_ENABLE, 			0);
	SHTPS_PARAM_DEF( SHTPS_CLING_REJECT_HOVER_MODE_3_ENABLE, 			0);
	SHTPS_PARAM_DEF( SHTPS_CLING_REJECT_HOVER_MODE_4_ENABLE, 			0);
	...
	SHTPS_PARAM_DEF( SHTPS_CLING_REJECT_FINGER_MODE_2_ENABLE, 			0);
	SHTPS_PARAM_DEF( SHTPS_CLING_REJECT_FINGER_MODE_3_ENABLE, 			0);
	SHTPS_PARAM_DEF( SHTPS_CLING_REJECT_FINGER_MODE_4_ENABLE, 			0);
	SHTPS_PARAM_DEF( SHTPS_CLING_REJECT_FINGER_MODE_5_ENABLE, 			0);
	SHTPS_PARAM_DEF( SHTPS_CLING_REJECT_FINGER_MODE_6_ENABLE, 			0);

	SHTPS_PARAM_DEF( SHTPS_CLING_REJECT_FINGER_MODE_5_CNT_MAX, 			150);
	SHTPS_PARAM_DEF( SHTPS_CLING_REJECT_FINGER_MODE_5_TU_CNT_MAX, 		3);
	SHTPS_PARAM_DEF( SHTPS_CLING_REJECT_FINGER_MODE_6_CNT_MAX, 			250);
	SHTPS_PARAM_DEF( SHTPS_CLING_REJECT_FINGER_MODE_6_THRESH,			50);
	SHTPS_PARAM_DEF( SHTPS_CLING_REJECT_FINGER_MODE_6_FINGER_MAX, 		2);
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_AREA_THRESH_X,	40);
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_AREA_THRESH_Y,	642);
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_DISTANCE,			376);
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_Z_RATIO,			112);
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_Z_RATIO_2,		129);
	...
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_SIDE_AREA_THRESH_X,			20);
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_SIDE_AREA_THRESH_ZW_RATIO,	150);
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_SIDE_AREA_THRESH_W,			21);
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_PRM_DIAGONAL_GHOST_CHECK_ENABLE,			0);
	SHTPS_PARAM_DEF( SHTPS_DIAGONAL_GHOST_CHECK_AREA, 				156);
	SHTPS_PARAM_DEF( SHTPS_DIAGONAL_GHOST_Z_THRESHOLD, 				255);
	SHTPS_PARAM_DEF( SHTPS_DIAGONAL_GHOST_TIMEOUT, 					100);
	SHTPS_PARAM_DEF( SHTPS_DIAGONAL_GHOST_CHECK_AFTER_TU_ENABLE, 	1);
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_DRAG_SMOOTH_EXCLUDE_DOT,					14);
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_DRAG_SMOOTH_FLATTERY_LEAVE_MAX_DOT,						22);
	...
	SHTPS_PARAM_DEF( SHTPS_DRAG_SMOOTH_FLATTERY_EXCLUDE_DOT,						14);
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_COAXIAL_GHOST_REJECT_MODE0_ENABLE, 		0);
	...
	SHTPS_PARAM_DEF( SHTPS_COAXIAL_GHOST_REJECT_YDIFF_THRESH_MV_ST,	70);
	SHTPS_PARAM_DEF( SHTPS_COAXIAL_GHOST_REJECT_YDIFF_THRESH_TD,	150);
	SHTPS_PARAM_DEF( SHTPS_COAXIAL_GHOST_REJECT_YDIFF_THRESH_TD_ST,	70);
	SHTPS_PARAM_DEF( SHTPS_COAXIAL_GHOST_REJECT_Z_THRESH_MV, 		50);
	SHTPS_PARAM_DEF( SHTPS_COAXIAL_GHOST_REJECT_Z_THRESH_MV_ST, 	68);
	SHTPS_PARAM_DEF( SHTPS_COAXIAL_GHOST_REJECT_Z_THRESH_TD, 		50);
	SHTPS_PARAM_DEF( SHTPS_COAXIAL_GHOST_REJECT_Z_THRESH_TD_ST,		68);

	SHTPS_PARAM_DEF( SHTPS_COAXIAL_GHOST_REJECT_MODE1_ENABLE, 				1);
	SHTPS_PARAM_DEF( SHTPS_COAXIAL_GHOST_REJECT_MODE1_XDIFF_THRESH,			30);
	SHTPS_PARAM_DEF( SHTPS_COAXIAL_GHOST_REJECT_MODE1_YDIFF_THRESH,			150);
	SHTPS_PARAM_DEF( SHTPS_COAXIAL_GHOST_REJECT_MODE1_Z_THRESH,				25);
	SHTPS_PARAM_DEF( SHTPS_COAXIAL_GHOST_REJECT_MODE1_FINGER_NUM_THRESH,	2);
	SHTPS_PARAM_DEF( SHTPS_COAXIAL_GHOST_REJECT_MODE1_CHECK_TIME,			500);
	SHTPS_PARAM_DEF( SHTPS_COAXIAL_GHOST_REJECT_MODE1_COUNT_MAX,			1);

	#if defined( SHTPS_LOG_DEBUG_ENABLE )
		SHTPS_PARAM_DEF( SHTPS_COAXIAL_GHOST_REJECT_LOG_ENABLE, 0);
		#define	SHTPS_LOG_COAXIAL_GHOST_REJECT(...)								\
			if(SHTPS_COAXIAL_GHOST_REJECT_LOG_ENABLE != 0){						\
				printk(KERN_DEBUG "[shtps] [COAXIAL_GHOST]" __VA_ARGS__);		\
			}
	#else
		#define	SHTPS_LOG_COAXIAL_GHOST_REJECT(...)
	#endif /* SHTPS_LOG_DEBUG_ENABLE */
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_CTRL_FW_REPORT_RATE_PARAM_DEFAULT, 		0x5E);
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_REG_PRM_ENABLE_LIFT_CONDITION, 			1);
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_FACETOUCH_SLEEP_MOTION_SUPPRESSION_CHG_ENABLE,		0);
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_INVERTING_GHOST_REJECT_ENABLE,				0);
	SHTPS_PARAM_DEF( SHTPS_INVERTING_GHOST_REJECT_PROXIMITY_CHECK_ENABLE,	0);
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_PRM_DIAGONAL_CLING_CHECK_ENABLE,			0);
	SHTPS_PARAM_DEF( SHTPS_DIAGONAL_CLING_CHECK_AREA, 				100);
	SHTPS_PARAM_DEF( SHTPS_DIAGONAL_CLING_Z_THRESHOLD, 				255);
	SHTPS_PARAM_DEF( SHTPS_DIAGONAL_CLING_TIMEOUT, 					2000);
	SHTPS_PARAM_DEF( SHTPS_DIAGONAL_CLING_CHECK_AFTER_TU_ENABLE, 	1);
	SHTPS_PARAM_DEF( SHTPS_DIAGONAL_CLING_CHECK_COUNT_THRESH, 		100);
	SHTPS_PARAM_DEF( SHTPS_DIAGONAL_CLING_CHECK_MONITORING_FINGER_NUM_MAX, 1);

	#if defined( SHTPS_LOG_DEBUG_ENABLE )
		SHTPS_PARAM_DEF( SHTPS_DIAGONAL_CLING_LOG_ENABLE, 	0);
	    #define	SHTPS_DIAGONAL_CLING_PRINT(...)				\
	        if(SHTPS_DIAGONAL_CLING_LOG_ENABLE != 0){	\
	            printk(KERN_DEBUG "[shtps] [diagonal cling]" __VA_ARGS__);	\
	        }
	#else
		#define	SHTPS_DIAGONAL_CLING_PRINT(...)
	#endif /* SHTPS_LOG_DEBUG_ENABLE */
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_PRM_CTRL_FW_BASELINE_CHECKER_ENABLE,		0);
...
#endif /* __SHTPS_PARAM_PLG484_001_H__ */
