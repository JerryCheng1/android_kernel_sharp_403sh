 ...
 */
	...
	SHTPS_PARAM_DEF(SHTPS_FACETOUCH_DETECT_PALMDET_W_THRESHOLD,		50);
...
//	SHTPS_PARAM_DEF(SHTPS_LOS_MULTI,								0x40);
		...
		SHTPS_PARAM_DEF( SHTPS_FACETOUCHOFF_DETECT_SKIP_REZERO_FIRST_TIME_MS, 	1500);
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_LPWG_DOZE_WAKEUP_THRESHOLD_DEF, 	0x1E);
	SHTPS_PARAM_DEF( SHTPS_LPWG_DOZE_WAKEUP_THRESHOLD, 		0x1E);
	...
	SHTPS_PARAM_DEF( SHTPS_LPWG_RECEIVER_PITCH,				0x5C78);
	SHTPS_PARAM_DEF( SHTPS_LPWG_TRANSMITTER_PITCH,			0x5E92);
		...
		SHTPS_PARAM_DEF( SHTPS_F51_REPORT_BEYOND_ACTIVE_AREA_ADDR, 	0x0401);
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_CLING_REJECT_FINGER_MODE_5_ENABLE, 			1);
	SHTPS_PARAM_DEF( SHTPS_CLING_REJECT_FINGER_MODE_6_ENABLE, 			1);
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_AREA_THRESH_Y,	481);
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_DISTANCE,			334);
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_Z_RATIO,			91);
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_Z_RATIO_2,		84);
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_EFFECT_TIME,		571);
	...
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_BOTTOM_SIDE_AREA_THRESH_X,	27);
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_BOTTOM_SIDE_AREA_THRESH_Y,	489);
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_BOTTOM_SIDE_AREA_INHIBIT_CANCEL_MOVE_THRESH_Y,	160);
	...
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_BOTTOM_AREA_RELATION_ZWY_RATIO,	130);
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_BOTTOM_AREA_RELATION_ZWY_DIFF,	4000);
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_DRAG_SMOOTH_USE_HULL,					0);
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_DRAG_SMOOTH_FLATTERY,									0);
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_COAXIAL_GHOST_REJECT_ENABLE, 			0);
	...
	SHTPS_PARAM_DEF( SHTPS_COAXIAL_GHOST_REJECT_MODE1_ENABLE, 				0);
	SHTPS_PARAM_DEF( SHTPS_COAXIAL_GHOST_REJECT_MODE1_XDIFF_THRESH,			30);
	SHTPS_PARAM_DEF( SHTPS_COAXIAL_GHOST_REJECT_MODE1_YDIFF_THRESH,			48);
	SHTPS_PARAM_DEF( SHTPS_COAXIAL_GHOST_REJECT_MODE1_Z_THRESH,				10);
	SHTPS_PARAM_DEF( SHTPS_COAXIAL_GHOST_REJECT_MODE1_FINGER_NUM_THRESH,	2);
	SHTPS_PARAM_DEF( SHTPS_COAXIAL_GHOST_REJECT_MODE1_CHECK_TIME,			200);
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_PRM_DIAGONAL_CLING_CHECK_ENABLE,			1);
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_PRM_CTRL_FW_BASELINE_CHECKER_ENABLE,		1);
