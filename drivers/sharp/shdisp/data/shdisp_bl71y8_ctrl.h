...
static const shdisp_bdicRegSetting_t shdisp_bdic_ps_init_als_on4[] = {
    ...
    ,{BDIC_REG_SYSTEM8,             SHDISP_BDIC_STR,    0x00,                           0xFF,       0}
    ,{BDIC_REG_AR_CTRL,             SHDISP_BDIC_STR,    0x0E,                           0xFF,       0}
    ,{BDIC_REG_AR_HI_TH_L_L,        SHDISP_BDIC_STR,    BDIC_REG_AR_HI_TH_L_L_VAL_PS_ON,  0xFF,     0}
    ,{BDIC_REG_AR_HI_TH_L_H,        SHDISP_BDIC_STR,    BDIC_REG_AR_HI_TH_L_H_VAL_PS_ON,  0xFF,     0}
    ,{BDIC_REG_AR_LO_TH_M_L,        SHDISP_BDIC_STR,    BDIC_REG_AR_LO_TH_M_L_VAL_PS_ON,  0xFF,     0}
    ,{BDIC_REG_AR_LO_TH_M_H,        SHDISP_BDIC_STR,    BDIC_REG_AR_LO_TH_M_H_VAL_PS_ON,  0xFF,     0}
    ,{BDIC_REG_AR_HI_TH_M_L,        SHDISP_BDIC_STR,    BDIC_REG_AR_HI_TH_M_L_VAL_PS_ON,  0xFF,     0}
    ,{BDIC_REG_AR_HI_TH_M_H,        SHDISP_BDIC_STR,    BDIC_REG_AR_HI_TH_M_H_VAL_PS_ON,  0xFF,     0}
    ,{BDIC_REG_AR_LO_TH_H_L,        SHDISP_BDIC_STR,    BDIC_REG_AR_LO_TH_H_L_VAL_PS_ON,  0xFF,     0}
    ,{BDIC_REG_AR_LO_TH_H_H,        SHDISP_BDIC_STR,    BDIC_REG_AR_LO_TH_H_H_VAL_PS_ON,  0xFF,     0}
    ...
    ,{BDIC_REG_AR_CTRL,             SHDISP_BDIC_STR,    0x8E,                           0xFF,       0}
    ,{BDIC_REG_SYSTEM8,             SHDISP_BDIC_STR,    0x04,                           0xFF,       (35*1000)}
    ,{BDIC_REG_GIMR1,               SHDISP_BDIC_STR,    0x08,                           0xFF,       0}
    ,{BDIC_REG_GIMF1,               SHDISP_BDIC_STR,    0x08,                           0xFF,       0}
};
...
static shdisp_bdicRegSetting_t shdisp_bdic_set_als_shift_ps_off[] = {
     {BDIC_REG_BANKSEL,             SHDISP_BDIC_BANK,   0x01,                       0x00,       0},
     {BDIC_REG_ALS_SHIFT_0,         SHDISP_BDIC_STR,    BDIC_REG_ALS_SHIFT_PS_OFF,                       0xFF,       0},
     {BDIC_REG_ALS_SHIFT_1,         SHDISP_BDIC_STR,    BDIC_REG_ALS_SHIFT_PS_OFF,                       0xFF,       0},
     {BDIC_REG_ALS_SHIFT_2,         SHDISP_BDIC_STR,    BDIC_REG_ALS_SHIFT_PS_OFF,                       0xFF,       0},
     {BDIC_REG_ALS_SHIFT_3,         SHDISP_BDIC_STR,    BDIC_REG_ALS_SHIFT_PS_OFF,                       0xFF,       0},
     {BDIC_REG_BANKSEL,             SHDISP_BDIC_BANK,   0x00,                       0x00,       0},
};

static shdisp_bdicRegSetting_t shdisp_bdic_set_als_shift_ps_on[] = {
     {BDIC_REG_BANKSEL,             SHDISP_BDIC_BANK,   0x01,                       0x00,       0},
     {BDIC_REG_ALS_SHIFT_0,         SHDISP_BDIC_STR,    BDIC_REG_ALS_SHIFT_PS_ON,                       0xFF,       0},
     {BDIC_REG_ALS_SHIFT_1,         SHDISP_BDIC_STR,    BDIC_REG_ALS_SHIFT_PS_ON,                       0xFF,       0},
     {BDIC_REG_ALS_SHIFT_2,         SHDISP_BDIC_STR,    BDIC_REG_ALS_SHIFT_PS_ON,                       0xFF,       0},
     {BDIC_REG_ALS_SHIFT_3,         SHDISP_BDIC_STR,    BDIC_REG_ALS_SHIFT_PS_ON,                       0xFF,       0},
     {BDIC_REG_BANKSEL,             SHDISP_BDIC_BANK,   0x00,                       0x00,       0}
};
...
static shdisp_bdicRegSetting_t const shdisp_bdic_reg_ar_ctrl[] = {
     {BDIC_REG_SYSTEM8,             SHDISP_BDIC_STR,    0x00,                       0xFF,       0}
    ,{BDIC_REG_AR_CTRL,             SHDISP_BDIC_STR,    0x8A,                       0xFF,       0}
    ,{BDIC_REG_SYSTEM8,             SHDISP_BDIC_STR,    0x04,                       0xFF,       0}
};
