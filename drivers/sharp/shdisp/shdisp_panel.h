...
#define SHDISP_CMD_REQ_LP_MODE                           0x10
#define SHDISP_CMD_REQ_HS_MODE                           0x20
...
struct shdisp_panel_operations {
    ...
    int (*write_reg)(unsigned char addr, unsigned char *write_data, unsigned char size, int power_mode);
    int (*read_reg)(unsigned char addr, unsigned char *read_data, unsigned char size, int power_mode);
