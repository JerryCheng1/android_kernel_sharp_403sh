...
#define PM8926_GPIO_BASE	440
#define PM8926_GPIO_PM_TO_SYS(pm_gpio)		(pm_gpio - 1 + PM8926_GPIO_BASE)
...
#define SHCHG_GPIO_NUM_EXT_TRANSIST_SWITCH         PM8926_GPIO_PM_TO_SYS(2)
...
#define SHCHG_DRV_IOCTL_CMD_FLASH_IS_ENABLE								_IOR( SHCHG_IOC_MAGIC, 31, int)
#ifdef SHCHG_ENABLE_EXTERNAL_OVP_FET
#define SHCHG_DRV_IOCTL_CMD_RESTORE_CHARGER_CIN_TRIM					_IO( SHCHG_IOC_MAGIC, 32)
#define SHCHG_DRV_IOCTL_CMD_SET_CHARGER_CIN_TRIM					_IOW( SHCHG_IOC_MAGIC, 33, int)
#define SHCHG_DRV_IOCTL_CMD_GET_CHARGER_CIN_TRIM					_IOR( SHCHG_IOC_MAGIC, 34, int)
#define SHCHG_DRV_IOCTL_CMD_SET_CHARGER_EXT_TRANSISTOR_SWITCH				_IOW( SHCHG_IOC_MAGIC, 35, shchg_pm_sw_t)
#define SHCHG_DRV_IOCTL_CMD_GET_CHARGER_EXT_TRANSISTOR_SWITCH				_IOR( SHCHG_IOC_MAGIC, 36, shchg_pm_sw_t)
#define SHCHG_DRV_IOCTL_CMD_GET_CHARGER_ICHG_LOOP					_IOR( SHCHG_IOC_MAGIC, 37, bool)
#define SHCHG_DRV_IOCTL_CMD_GET_CHARGER_VCHG_LOOP					_IOR( SHCHG_IOC_MAGIC, 38, bool)
#define SHCHG_DRV_IOCTL_CMD_GET_CHARGER_IBAT_LOOP					_IOR( SHCHG_IOC_MAGIC, 40, bool)
#define SHCHG_DRV_IOCTL_CMD_GET_CHARGER_VDD_LOOP					_IOR( SHCHG_IOC_MAGIC, 41, bool)
#endif /* SHCHG_ENABLE_EXTERNAL_OVP_FET */
#define SHCHG_DRV_IOCTL_CMD_TORCH_IS_ENABLE								_IOR( SHCHG_IOC_MAGIC, 39, int)
...
static int shchg_boot_time_dcp_charger_type = -1;
...
#ifdef SHCHG_ENABLE_EXTERNAL_OVP_FET
static shchg_pm_sw_t shchg_cur_ext_switch_state = SHCHG_PM_SW_OFF;
#endif /* SHCHG_ENABLE_EXTERNAL_OVP_FET */
static int shchg_debug_charge_flg = 0;
module_param_named(debug_charge, shchg_debug_charge_flg, int, S_IRUSR | S_IWUSR);
...
#ifdef SHCHG_ENABLE_EXTERNAL_OVP_FET
extern int qpnp_chg_charger_iusb_trim_restore( void );
extern int qpnp_chg_charger_iusb_trim_set(int trim);
extern int qpnp_chg_charger_iusb_trim_get(int* trim);
extern int qpnp_chg_charger_ichg_loop_get(bool* il_p);
extern int qpnp_chg_charger_vchg_loop_get(bool* vl_p);
extern int qpnp_chg_charger_ibat_loop_get(bool* il_p);
extern int qpnp_chg_charger_vdd_loop_get(bool* vl_p);
#endif /* SHCHG_ENABLE_EXTERNAL_OVP_FET */
...
static void shchg_task_cmd_notify_hvdcp_change_result(shchg_packet_t* pkt_p);
static void shchg_task_cmd_notify_dcp_charger_type(shchg_packet_t* pkt_p);
...
static shchg_result_t shchg_seq_notify_hvdcp_change_result(int change_result);
static shchg_result_t shchg_seq_notify_dcp_charger_type(int is_hvdcp);
...
#ifdef SHCHG_ENABLE_EXTERNAL_OVP_FET
static shchg_result_t shchg_pm_restore_charger_iusb_trim( void );
static shchg_result_t shchg_pm_set_charger_iusb_trim( int trim );
static shchg_result_t shchg_pm_get_charger_iusb_trim( int* trim_p );
static shchg_result_t shchg_pm_set_charger_ext_transistor_switch( shchg_pm_sw_t sw );
static shchg_result_t shchg_pm_get_charger_ext_transistor_switch( shchg_pm_sw_t* sw );
static shchg_result_t shchg_pm_get_charger_ichg_loop( bool* il_p );
static shchg_result_t shchg_pm_get_charger_vchg_loop( bool* vl_p );
static shchg_result_t shchg_pm_get_charger_ibat_loop( bool* il_p );
static shchg_result_t shchg_pm_get_charger_vdd_loop( bool* vl_p );
#endif /* SHCHG_ENABLE_EXTERNAL_OVP_FET */
...
static int shchg_drv_ioctl_cmd_flash_is_enable( struct file* fi_p, unsigned long arg );
#ifdef SHCHG_ENABLE_EXTERNAL_OVP_FET
static int shchg_drv_ioctl_cmd_restore_charger_iusb_trim( struct file* fi_p, unsigned long arg );
static int shchg_drv_ioctl_cmd_set_charger_iusb_trim( struct file* fi_p, unsigned long arg );
static int shchg_drv_ioctl_cmd_get_charger_iusb_trim( struct file* fi_p, unsigned long arg );
static int shchg_drv_ioctl_cmd_set_charger_ext_transistor_switch( struct file* fi_p, unsigned long arg );
static int shchg_drv_ioctl_cmd_get_charger_ext_transistor_switch( struct file* fi_p, unsigned long arg );
static int shchg_drv_ioctl_cmd_get_charger_ichg_loop( struct file* fi_p, unsigned long arg );
static int shchg_drv_ioctl_cmd_get_charger_vchg_loop( struct file* fi_p, unsigned long arg );
static int shchg_drv_ioctl_cmd_get_charger_ibat_loop( struct file* fi_p, unsigned long arg );
static int shchg_drv_ioctl_cmd_get_charger_vdd_loop( struct file* fi_p, unsigned long arg );
#endif /* SHCHG_ENABLE_EXTERNAL_OVP_FET */
static int shchg_drv_ioctl_cmd_torch_is_enable( struct file* fi_p, unsigned long arg );
...
static void (*const shchg_task_cmd_func[])( shchg_packet_t* pkt_p ) = 
{
	...
	shchg_task_cmd_notify_hvdcp_change_result,
	shchg_task_cmd_notify_dcp_charger_type,
};
...
shchg_result_t shchg_api_notify_hvdcp_change_result(int change_result)
{
	shchg_packet_t* pkt_p;
	...
	pkt_p->hdr.cmd = SHCHG_CMD_NOTIFY_HVDCP_CHANGE_RESULT;
	pkt_p->hdr.cb_p = NULL;
	pkt_p->hdr.cmp_p = NULL;
	pkt_p->hdr.ret_p = NULL;
	pkt_p->prm.val = change_result;
...
shchg_result_t shchg_api_notify_dcp_charger_type( int is_hvdcp)
{
	shchg_packet_t* pkt_p;
	...
	if(shchg_task_is_initialized == false)
	{
		shchg_boot_time_dcp_charger_type = is_hvdcp;
		printk(KERN_INFO "%s: dcp_charger_type = %d\n", __FUNCTION__, is_hvdcp);
		return SHCHG_RESULT_REJECTED;
	}
	...
	pkt_p->hdr.cmd = SHCHG_CMD_NOTIFY_DCP_CHARGER_TYPE;
	pkt_p->hdr.cb_p = NULL;
	pkt_p->hdr.cmp_p = NULL;
	pkt_p->hdr.ret_p = NULL;
	pkt_p->prm.val = is_hvdcp;
...
static void shchg_task_cmd_notify_hvdcp_change_result(shchg_packet_t* pkt_p)
{
	...
	shchg_seq_notify_hvdcp_change_result(pkt_p->prm.val);
...
static void shchg_task_cmd_notify_dcp_charger_type(shchg_packet_t* pkt_p)
{
	...
	shchg_seq_notify_dcp_charger_type(pkt_p->prm.val);
...
static shchg_result_t shchg_seq_initialize( void )
{
	...
	if(shchg_boot_time_dcp_charger_type != -1)
	{
		shchg_seq_notify_dcp_charger_type(shchg_boot_time_dcp_charger_type);
	}
...
static shchg_result_t shchg_pm_flash_is_enable( int* flash_enable )
{
	SHCHG_TRACE("[S] %s \n",__FUNCTION__);

	*flash_enable = qpnp_chg_flash_is_enable();

	SHCHG_TRACE("[E] %s flash_enable = %d\n",__FUNCTION__, *flash_enable);

	return SHCHG_RESULT_SUCCESS;
}

static shchg_result_t shchg_pm_torch_is_enable( int* torch_enable )
{
	SHCHG_TRACE("[S] %s \n",__FUNCTION__);

	*torch_enable = qpnp_chg_torch_is_enable();

	SHCHG_TRACE("[E] %s torch_enable = %d\n",__FUNCTION__, *torch_enable);
...
static shchg_result_t shchg_pm_restore_charger_iusb_trim( void )
{
	...
	do
	{
		rc = qpnp_chg_charger_iusb_trim_restore();
		if (rc)
		{
			result = SHBATT_RESULT_FAIL;
			SHCHG_ERROR("error qpnp_chg_charger_iusb_trim_restore, rc = %d\n", rc);
			break;
		}
	}
	while(0);
...
static shchg_result_t shchg_pm_set_charger_iusb_trim( int trim )
{
	...
	do
	{
		SHCHG_TRACE("[iusb_trim] %d\n", trim);
		rc = qpnp_chg_charger_iusb_trim_set( trim );
		if (rc)
		{
			result = SHBATT_RESULT_FAIL;
			SHCHG_ERROR("error qpnp_chg_charger_iusb_trim_set = %d, rc = %d\n", trim, rc);
			break;
		}
	}
	while(0);
...
static shchg_result_t shchg_pm_get_charger_iusb_trim( int* trim_p )
{
	...
	if(trim_p != NULL)
	{
		rc = qpnp_chg_charger_iusb_trim_get( trim_p );
		if (rc)
		{
			result = SHBATT_RESULT_FAIL;
			SHCHG_ERROR("error qpnp_chg_charger_iusb_trim_get = %d, rc = %d\n", *trim_p, rc);
		}
		SHCHG_TRACE("[iusb_trim] %d\n", *trim_p);
	}
...
static shchg_result_t shchg_pm_set_charger_ext_transistor_switch( shchg_pm_sw_t sw )
{
	...
	SHCHG_TRACE("[S] %s sw=%d shchg_cur_ext_switch_state=%d \n",__FUNCTION__, sw, shchg_cur_ext_switch_state);

	if(qpnp_chg_torch_is_enable() != 0)
	{
		SHCHG_TRACE("[P] %s torch is on, so set SW_OFF\n",__FUNCTION__);
		GPIO_SET(SHCHG_GPIO_NUM_EXT_TRANSIST_SWITCH, 0);
		shchg_cur_ext_switch_state = SHCHG_PM_SW_OFF;
		SHCHG_TRACE("[E] %s \n",__FUNCTION__);
		return result;
	}

	if(sw != shchg_cur_ext_switch_state)
	{
		if(sw)
			GPIO_SET(SHCHG_GPIO_NUM_EXT_TRANSIST_SWITCH, 1);
		else
			GPIO_SET(SHCHG_GPIO_NUM_EXT_TRANSIST_SWITCH, 0);

		shchg_cur_ext_switch_state = sw;
	}
...
static shchg_result_t shchg_pm_get_charger_ichg_loop( bool* il_p )
{
	...
	if(il_p != NULL)
	{
		rc = qpnp_chg_charger_ichg_loop_get( il_p );
		if (rc)
		{
			result = SHBATT_RESULT_FAIL;
			SHCHG_ERROR("error qpnp_chg_charger_ichg_loop_get = %d, rc = %d\n", *il_p, rc);
		}
		SHCHG_TRACE("[ichg_loop] %d\n", *il_p);
	}
...
static shchg_result_t shchg_pm_get_charger_vchg_loop( bool* vl_p )
{
	...
	if(vl_p != NULL)
	{
		rc = qpnp_chg_charger_vchg_loop_get( vl_p );
		if (rc)
		{
			result = SHBATT_RESULT_FAIL;
			SHCHG_ERROR("error qpnp_chg_charger_vchg_loop_get = %d, rc = %d\n", *vl_p, rc);
		}
		SHCHG_TRACE("[vchg_loop] %d\n", *vl_p);
	}
...
static shchg_result_t shchg_pm_get_charger_ibat_loop( bool* il_p )
{
	...
	if(il_p != NULL)
	{
		rc = qpnp_chg_charger_ibat_loop_get( il_p );
		if (rc)
		{
			result = SHBATT_RESULT_FAIL;
			SHCHG_ERROR("error qpnp_chg_charger_ibat_loop_get = %d, rc = %d\n", *il_p, rc);
		}
		SHCHG_TRACE("[ibat_loop] %d\n", *il_p);
	}
...
static shchg_result_t shchg_pm_get_charger_vdd_loop( bool* vl_p )
{
	...
	if(vl_p != NULL)
	{
		rc = qpnp_chg_charger_vdd_loop_get( vl_p );
		if (rc)
		{
			result = SHBATT_RESULT_FAIL;
			SHCHG_ERROR("error qpnp_chg_charger_vdd_loop_get = %d, rc = %d\n", *vl_p, rc);
		}
		SHCHG_TRACE("[vdd_loop] %d\n", *vl_p);
	}
...
static long shchg_drv_ioctl( struct file* fi_p, unsigned int cmd, unsigned long arg )
{
	...
	else if(cmd == SHCHG_DRV_IOCTL_CMD_FLASH_IS_ENABLE)
	{
		ret = shchg_drv_ioctl_cmd_flash_is_enable(fi_p,arg);
	}
	else if(cmd == SHCHG_DRV_IOCTL_CMD_TORCH_IS_ENABLE)
	{
		ret = shchg_drv_ioctl_cmd_torch_is_enable(fi_p,arg);
	}
#ifdef SHCHG_ENABLE_EXTERNAL_OVP_FET
	else if(cmd == SHCHG_DRV_IOCTL_CMD_RESTORE_CHARGER_CIN_TRIM)
	{
		ret = shchg_drv_ioctl_cmd_restore_charger_iusb_trim(fi_p,arg);
	}
	else if(cmd == SHCHG_DRV_IOCTL_CMD_SET_CHARGER_CIN_TRIM)
	{
		ret = shchg_drv_ioctl_cmd_set_charger_iusb_trim(fi_p,arg);
	}
	else if(cmd == SHCHG_DRV_IOCTL_CMD_GET_CHARGER_CIN_TRIM)
	{
		ret = shchg_drv_ioctl_cmd_get_charger_iusb_trim(fi_p,arg);
	}
	else if(cmd == SHCHG_DRV_IOCTL_CMD_SET_CHARGER_EXT_TRANSISTOR_SWITCH)
	{
		ret = shchg_drv_ioctl_cmd_set_charger_ext_transistor_switch(fi_p,arg);
	}
	else if(cmd == SHCHG_DRV_IOCTL_CMD_GET_CHARGER_EXT_TRANSISTOR_SWITCH)
	{
		ret = shchg_drv_ioctl_cmd_get_charger_ext_transistor_switch(fi_p,arg);
	}
	else if(cmd == SHCHG_DRV_IOCTL_CMD_GET_CHARGER_ICHG_LOOP)
	{
		ret = shchg_drv_ioctl_cmd_get_charger_ichg_loop(fi_p,arg);
	}
	else if(cmd == SHCHG_DRV_IOCTL_CMD_GET_CHARGER_VCHG_LOOP)
	{
		ret = shchg_drv_ioctl_cmd_get_charger_vchg_loop(fi_p,arg);
	}
	else if(cmd == SHCHG_DRV_IOCTL_CMD_GET_CHARGER_IBAT_LOOP)
	{
		ret = shchg_drv_ioctl_cmd_get_charger_ibat_loop(fi_p,arg);
	}
	else if(cmd == SHCHG_DRV_IOCTL_CMD_GET_CHARGER_VDD_LOOP)
	{
		ret = shchg_drv_ioctl_cmd_get_charger_vdd_loop(fi_p,arg);
	}
#endif /* SHCHG_ENABLE_EXTERNAL_OVP_FET */
	else
	{
...
static int shchg_drv_ioctl_cmd_flash_is_enable( struct file* fi_p, unsigned long arg )
{
	...
	shchg_pm_flash_is_enable(&flash_enable);

	if(copy_to_user((int*)arg,&flash_enable,sizeof(int)) != 0)
	{
		SHCHG_ERROR("%s : copy_to_user failed.\n",__FUNCTION__);
		ret = -EPERM;
	}
...
static int shchg_drv_ioctl_cmd_torch_is_enable( struct file* fi_p, unsigned long arg )
{
	...
	shchg_pm_torch_is_enable(&torch_enable);

	if(copy_to_user((int*)arg,&torch_enable,sizeof(int)) != 0)
	{
		SHCHG_ERROR("%s : copy_to_user failed.\n",__FUNCTION__);
		ret = -EPERM;
	}
...
static int shchg_drv_ioctl_cmd_restore_charger_iusb_trim( struct file* fi_p, unsigned long arg )
{
	...
	shchg_pm_restore_charger_iusb_trim();
...
static int shchg_drv_ioctl_cmd_set_charger_iusb_trim( struct file* fi_p, unsigned long arg )
{
	...
	if(copy_from_user(&trim,(int*)arg,sizeof(int)) != 0)
	{
		SHCHG_ERROR("%s : copy_from_user failed.\n",__FUNCTION__);
		ret = -EPERM;
	}
	...
	{
		shchg_pm_set_charger_iusb_trim(trim);
	}
...
static int shchg_drv_ioctl_cmd_get_charger_iusb_trim( struct file* fi_p, unsigned long arg )
{
	...
	shchg_pm_get_charger_iusb_trim(&trim);

	if(copy_to_user((int*)arg,&trim,sizeof(int)) != 0)
	{
		SHCHG_ERROR("%s : copy_to_user failed.\n",__FUNCTION__);
		ret = -EPERM;
	}
...
static int shchg_drv_ioctl_cmd_set_charger_ext_transistor_switch( struct file* fi_p, unsigned long arg )
{
	...
	{
		shchg_pm_set_charger_ext_transistor_switch(sw);
	}
...
static int shchg_drv_ioctl_cmd_get_charger_ext_transistor_switch( struct file* fi_p, unsigned long arg )
{
	...
	shchg_pm_get_charger_ext_transistor_switch(&sw);

	if(copy_to_user((shchg_pm_sw_t*)arg,&sw,sizeof(shchg_pm_sw_t)) != 0)
	{
		SHCHG_ERROR("%s : copy_from_user failed.\n",__FUNCTION__);
		ret = -EPERM;
	}
...
static int shchg_drv_ioctl_cmd_get_charger_ichg_loop( struct file* fi_p, unsigned long arg )
{
	...
	shchg_pm_get_charger_ichg_loop(&il);

	if(copy_to_user((bool*)arg,&il,sizeof(int)) != 0)
	{
		SHCHG_ERROR("%s : copy_to_user failed.\n",__FUNCTION__);
		ret = -EPERM;
	}
...
static int shchg_drv_ioctl_cmd_get_charger_vchg_loop( struct file* fi_p, unsigned long arg )
{
	...
	shchg_pm_get_charger_vchg_loop(&vl);

	if(copy_to_user((bool*)arg,&vl,sizeof(int)) != 0)
	{
		SHCHG_ERROR("%s : copy_to_user failed.\n",__FUNCTION__);
		ret = -EPERM;
	}
...
static int shchg_drv_ioctl_cmd_get_charger_ibat_loop( struct file* fi_p, unsigned long arg )
{
	...
	shchg_pm_get_charger_ibat_loop(&il);
...
static int shchg_drv_ioctl_cmd_get_charger_vdd_loop( struct file* fi_p, unsigned long arg )
{
	...
	shchg_pm_get_charger_vdd_loop(&vl);
...
static shchg_result_t shchg_seq_notify_hvdcp_change_result( int change_result)
{
	...
	shchg_usse_pkt.hdr.cmd = SHCHG_CMD_NOTIFY_HVDCP_CHANGE_RESULT;
	shchg_usse_pkt.hdr.ret = SHCHG_RESULT_FAIL;
	shchg_usse_pkt.prm.val = change_result;
...
static shchg_result_t shchg_seq_notify_dcp_charger_type(int is_hvdcp)
{
	...
	shchg_usse_pkt.hdr.cmd = SHCHG_CMD_NOTIFY_DCP_CHARGER_TYPE;
	shchg_usse_pkt.hdr.ret = SHCHG_RESULT_FAIL;
	shchg_usse_pkt.prm.val = is_hvdcp;
...
int shchg_api_is_debug_charge( void )
{
	return shchg_debug_charge_flg;
}

int shchg_api_is_charge_ignore( void )
{
	return shchg_charge_ignore_flg;
}
